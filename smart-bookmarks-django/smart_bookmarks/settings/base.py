...
LOGGING = {
    ...
    "loggers": {
        "foo": {"handlers": ["console"], "level": "DEBUG"},
...
CELERY_RESULT_BACKEND = (
    "rpc://"  # 'redis://{}:{}'.format(os.getenv('REDIS_HOST'), os.getenv('REDIS_PORT'))
)
...
CELERY_TASK_ROUTES = {
    ...
    # },
    "smart_bookmarks.scrapers.tasks.scrape_page": {"routing_key": "scraper.scrape-page"}
}
